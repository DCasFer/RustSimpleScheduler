...
impl Cpacr {
    bitfield_accessors! {
        //cp11 and cp10 to enable Floating Point Unit 0x00F00000
...
impl Icsr {
    bitfield_accessors! {
        //28 bit of ICSR
        pub [28] get_SCB_ICSR_PENDSVSET_Msk / with_SCB_ICSR_PENDSVSET_Msk : bool,
    }
}
...
impl Ccr {
    bitfield_accessors! {
        //9 bit of CCR
        pub [09] get_CCR_STKALIGN_Msk / with_CCR_STKALIGN_Msk: bool,
    }
}
...
impl Scb {
    ...
    reg_accessors!(icsr, Icsr, read_icsr, write_icsr, update_icsr);
    reg_accessors!(ccr, Ccr, read_ccr, write_ccr, update_ccr);
}
